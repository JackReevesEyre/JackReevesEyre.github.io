						...
						<div class="row gtr-200">
							...
							<section class="col-3 col-12-narrower">
								<div class="box highlight">
									...
									<h3>Position</h3>
									<p>I'm a meteorologist/oceanographer at NOAA Office of Coast Survey</p>
								</div>
							</section>
							<section class="col-3 col-12-narrower">
								<div class="box highlight">
							...
							<section class="col-3 col-12-narrower">
								<div class="box highlight">
									...
									<h3>Stats</h3>
									<p>Erd&#337s #: 5<br>Bacon #: 3<br>Rossby #: 5</p>
								</div>
							</section>
						</div>
					</div>
			...
			<!-- Gigantic Heading -->
				<section class="wrapper style2">
					<div class="container">
						...
						<p>I am a meteorologist and oceanographer interested in air-sea interactions. I work at NOAA Office of Coast Survey (as a contractor for Propel Solutions and Axiom Consultants, Inc.). I develop tools to assess the skill of STOFS coastal ocean models, with a focus on storm surge during extreme weather events. I also work on a number of other applications based on STOFS model output.</p>
						<p>Before this, I worked for Running Tide, where I developed tools to plan and quantify ocean-based carbon dioxide removal. Previously, I was a research scientist with ERT, based at NOAA's Climate Prediction Center. I was involved in projects on ocean monitoring, and simulation experiments using Earth system models and data assimilation systems. From 2020 to 2022, I was a postdoctoral scholar at the Cooperative Institute for Climate Ocean and Ecosystem Studies (University of Washington) and NOAA Pacific Marine Environmental Laboratory. I worked with Meghan Cronin and Dongxiao Zhang on direct covariance fluxes from Saildrone uncrewed vehicles. From 2015 to 2020 I was a graduate student in Xubin Zeng's research group at the University of Arizona. From 2009 to 2014, I worked at the Met Office (Exeter, UK), first as a weather forecaster then as a climate scientist.</p>
